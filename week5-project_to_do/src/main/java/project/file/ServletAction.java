...
public class ServletAction extends HttpServlet {
	...
	public void processAction(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, JSONException {
		...
		if (action == null){
			...
			if (action.equals("get_project_record")) {
				actionOk=true;
				try {
					getprojectRecord(request, response, json);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
			if (action.equals("add_project_record")) {
				actionOk=true;
				try {
					addprojectRecord(request, response, json);
				} catch (JSONException e) {
					e.printStackTrace();
				} catch (Exception e) {
					e.printStackTrace();
			...
			if (action.equals("modify_project_record")) {
				actionOk=true;
				try {
					modifyprojectRecord(request, response, json);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
			if (action.equals("delete_project_record")) {
				actionOk=true;
				try {
					deleteprojectRecord(request, response, json);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	/*========================================MySQL HTTP操作通用函数 结束========================================*/
	/*========================================CRUD业务函数 开始========================================*/
	private void getprojectRecord(HttpServletRequest request, HttpServletResponse response,JSONObject json) throws JSONException, SQLException {
		ProjectDao dao=new ProjectDao();
		Data data=getPageParameters(request,response,json);
		dao.getprojectRecord(data,json);
	}
	private void modifyprojectRecord(HttpServletRequest request, HttpServletResponse response,JSONObject json) throws JSONException, SQLException {
		ProjectDao dao=new ProjectDao();
		Data data=getPageParameters(request,response,json);
		dao.modifyprojectRecord(data,json);
	}
	private void deleteprojectRecord(HttpServletRequest request, HttpServletResponse response,JSONObject json) throws JSONException, SQLException {
		ProjectDao dao=new ProjectDao();
		Data data=getPageParameters(request,response,json);
		dao.deleteprojectRecord(data,json);
	}
	private void addprojectRecord(HttpServletRequest request, HttpServletResponse response,JSONObject json) throws JSONException, SQLException {
		ProjectDao dao=new ProjectDao();
		Data data=getPageParameters(request,response,json);
		dao.addprojectRecord(data,json);
	}
	/*========================================CRUD业务函数 结束========================================*/
	/*========================================上传文件函数 开始========================================*/
